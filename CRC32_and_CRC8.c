...
//verify here ---->>>> https://www.lddgo.net/en/encrypt/crc
...
const int order = 32;
const unsigned long polynom = 0x0000004D;
const int direct = 1;
...
uint8_t genrateCrc8(const uint8_t data[], uint32_t len)
{
	uint8_t crc   = 0x00U;
	uint8_t hex80 = 0x80U;
	uint32_t i, j;
